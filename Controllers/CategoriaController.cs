...
namespace NyousTarde.Controllers
{
    ...
    // Escrevemos Roles e o tipo do usuário para indicar qque apenas ele pode acessar esses métodos
    ...
    public class CategoriaController : ControllerBase
    {
        ...
        // GET: api/Categoria
        // Authorize aqui bloqueia método por método, assim esse método precisa de Token
        // [Authorize]
        [HttpGet]
